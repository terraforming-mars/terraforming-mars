...
export class LogBuilder {
  ...
  public rawString(value: string): LogBuilder {
    this.parameters.push(
      new LogMessageData(LogMessageDataType.RAW_STRING, value)
    );
    return this;
  }
  ...
  public number(value: number): LogBuilder {
    this.parameters.push(
      new LogMessageData(LogMessageDataType.RAW_STRING, value.toString())
    );
    return this;
  }
  ...
  public award(value: IAward): LogBuilder {
    this.parameters.push(
      new LogMessageData(LogMessageDataType.AWARD, value.name)
    );
    return this;
  }
  ...
  public milestone(value: IMilestone): LogBuilder {
    this.parameters.push(
      new LogMessageData(LogMessageDataType.MILESTONE, value.name)
    );
    return this;
  }
  ...
  public colony(value: Colony): LogBuilder {
    this.parameters.push(
      new LogMessageData(LogMessageDataType.COLONY, value.name)
    );
    return this;
  }
  ...
  public standardProject(value: string): LogBuilder {
    this.parameters.push(
      new LogMessageData(LogMessageDataType.STANDARD_PROJECT, value)
    );
    return this;
  }
  ...
  public party(value: IParty): LogBuilder {
    this.parameters.push(
      new LogMessageData(LogMessageDataType.PARTY, value.name)
    );
    return this;
  }
  ...
  public tileType(value: TileType): LogBuilder {
    this.parameters.push(
      new LogMessageData(LogMessageDataType.TILE_TYPE, value.toString())
    );
    return this;
  }
  ...
  public spaceBonus(value: SpaceBonus): LogBuilder {
    this.parameters.push(
      new LogMessageData(LogMessageDataType.SPACE_BONUS, value.toString())
    );
    return this;
  }
  ...
  public globalEventName(value: GlobalEventName): LogBuilder {
    this.parameters.push(
      new LogMessageData(LogMessageDataType.GLOBAL_EVENT, value.toString())
    );
    return this;
  }
