...
export class ArcticAlgae implements IProjectCard {
  ...
  public metadata: CardMetadata = {
    ...
    renderData: CardRenderer.builder((b) => b.effectBox((be) => be.oceans(1).any.startEffect.plants(2).description('Effect: When anyone places an ocean tile, gain 2 plants')).br.plants(1)),
  };
}
