...
export class Birds implements IActionCard, IProjectCard {
    ...
    public text: string = 'Requires 13% oxygen. Decrease any plant ' +
      'production 2 steps. Gain 1 victory point for each animal on this card.';
    public requirements: string = '13% Oxygen';
