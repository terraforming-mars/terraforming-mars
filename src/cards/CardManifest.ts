...
export class CardManifest {
  ...
  constructor(arg: {
    ...
    this.corporationCards = new Deck<CorporationCard>(
      arg.corporationCards || []
    );
    this.preludeCards = new Deck<IProjectCard>(arg.preludeCards || []);
    this.standardProjects = new Deck<StandardProjectCard>(
      arg.standardProjects || []
    );
    this.standardActions = new Deck<StandardActionCard>(
      arg.standardActions || []
    );
  }
}
