...
export class CommercialDistrict implements IProjectCard {
    ...
    public text: string = 'Decrease your energy production 1 step and ' +
      'increase your mega credit production 4 steps. Place a special tile.' +
      ' Gain 1 victory point per adjacent city tile.';
    public requirements: undefined;
    public description: string = 'Taking advantage of dense population ' +
      'centers.';
