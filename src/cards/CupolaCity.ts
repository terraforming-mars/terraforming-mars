...
export class CupolaCity implements IProjectCard {
    ...
    public text: string = 'Oxygen must be 9% or less. Place a city tile. ' +
      'Decrease your energy production 1 step and increase your mega credit ' +
      'production 3 steps.';
    public requirements: string = '9% or less Oxygen';
    public description: string = 'In a thin atmosphere, normal pressure can ' +
      'hold a protective dome over the city.';
