...
export class DustSeals implements IProjectCard {
    ...
    public text: string = 'Requires 3 or less ocean tiles. Gain 1 victory ' +
      'point.';
    public requirements: string = '3 or less Oceans';
    public description: string = 'Tight seals to keep micron-sized dust out ' +
      'of buildings, vehicles and suits.';
