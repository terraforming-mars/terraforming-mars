...
export class Flooding implements IProjectCard {
  ...
  public text: string = 'Place an ocean tile. IF THERE ARE TILES ADJACENT TO' +
    ' THIS OCEAN TILE, YOU MAY REMOVE 4 MEGA CREDITS FROM THE OWNER OF ONE ' +
    'OF THOSE TILES. Lose 1 victory point.';
