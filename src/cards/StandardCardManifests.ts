...
export const BASE_CARD_MANIFEST = new CardManifest({
  ...
  projectCards: [
    ...
    {
      cardName: CardName.AEROBRAKED_AMMONIA_ASTEROID,
    ...
    {
      cardName: CardName.COLONIZER_TRAINING_CAMP,
      Factory: ColonizerTrainingCamp,
    },
    ...
    {
      cardName: CardName.DESIGNED_MICRO_ORGANISMS,
      Factory: DesignedMicroOrganisms,
    },
    ...
    {
      cardName: CardName.EOS_CHASMA_NATIONAL_PARK,
      Factory: EosChasmaNationalPark,
    },
    ...
    {
      cardName: CardName.MAGNETIC_FIELD_GENERATORS,
      Factory: MagneticFieldGenerators,
    },
    ...
    {
      cardName: CardName.NITRITE_REDUCING_BACTERIA,
      Factory: NitriteReducingBacteria,
    },
    ...
    {
      cardName: CardName.UNDERGROUND_DETONATIONS,
      Factory: UndergroundDetonations,
    },
    {cardName: CardName.URBANIZED_AREA, Factory: UrbanizedArea},
    {
      cardName: CardName.WATER_IMPORT_FROM_EUROPA,
      Factory: WaterImportFromEuropa,
    },
  ...
  corporationCards: [
    ...
    {
      cardName: CardName.INTERPLANETARY_CINEMATICS,
      Factory: InterplanetaryCinematics,
    },
    ...
    {
      cardName: CardName.UNITED_NATIONS_MARS_INITIATIVE,
      Factory: UnitedNationsMarsInitiative,
    },
  ],
  standardProjects: [
    {
      cardName: CardName.AQUIFER_STANDARD_PROJECT,
      Factory: AquiferStandardProject,
    },
    {cardName: CardName.CITY_STANDARD_PROJECT, Factory: CityStandardProject},
    {
      cardName: CardName.POWER_PLANT_STANDARD_PROJECT,
      Factory: PowerPlantStandardProject,
    },
    {
      cardName: CardName.GREENERY_STANDARD_PROJECT,
      Factory: GreeneryStandardProject,
    },
    {
      cardName: CardName.ASTEROID_STANDARD_PROJECT,
      Factory: AsteroidStandardProject,
    },
    {
    ...
    {
      cardName: CardName.BUFFER_GAS_STANDARD_PROJECT,
      Factory: BufferGasStandardProject,
    },
  ],
  standardActions: [
...
export const CORP_ERA_CARD_MANIFEST = new CardManifest({
  ...
  projectCards: [
    ...
    {
      cardName: CardName.ANTI_GRAVITY_TECHNOLOGY,
      Factory: AntiGravityTechnology,
    },
    {
      cardName: CardName.ASTEROID_MINING_CONSORTIUM,
    ...
    {
      cardName: CardName.GREAT_ESCARPMENT_CONSORTIUM,
    ...
    {
      cardName: CardName.INTERSTELLAR_COLONY_SHIP,
      Factory: InterstellarColonyShip,
    },
    ...
    {
      cardName: CardName.POWER_SUPPLY_CONSORTIUM,
      Factory: PowerSupplyConsortium,
    },
    ...
    {
      cardName: CardName.TECHNOLOGY_DEMONSTRATION,
      Factory: TechnologyDemonstration,
    },
