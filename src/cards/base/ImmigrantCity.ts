    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          b.effect(
            'When a City tile is placed, including this, increase your M€ production 1 step.',
            (eb) => {
  ...
  public play(player: Player) {
    return new SelectSpace(
      ...
      (space: ISpace) => {
        ...
        player.game.defer(
          new LoseProduction(player, Resources.ENERGY, {count: 1})
        );
        player.game.defer(
          new LoseProduction(player, Resources.MEGACREDITS, {count: 2})
        );
        return undefined;
      }
    );
