  ...
  implements IActionCard, IProjectCard
{
  constructor(
    ...
    metadata: CardMetadata = {
      ...
      renderData: CardRenderer.builder((b) => {
        b.action(
          'Spend 7 M€ to increase your steel production 1 step.',
          (eb) => {
    ...
    return player.game.board
      ...
      .filter((space) =>
        player.game.board
          ...
          .some((adjacentSpace) => Board.isCitySpace(adjacentSpace))
      );
  }
  ...
  public action(player: Player) {
    player.game.defer(
      new SelectHowToPayDeferred(player, 7, {
