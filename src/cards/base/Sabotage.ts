    ...
    availablePlayerTargets.forEach((target) => {
      if (target.titanium > 0 && !target.alloysAreProtected()) {
        ...
        availableActions.options.push(new SelectOption(optionTitle, 'Confirm', () => {
          target.addResource(Resources.TITANIUM, -3, player.game, player);
          return undefined;
        }));
      }
      ...
      if (target.steel > 0 && !target.alloysAreProtected()) {
        ...
        availableActions.options.push(new SelectOption(optionTitle, 'Confirm', () => {
          target.addResource(Resources.STEEL, -4, player.game, player);
          return undefined;
        }));
      }
      ...
      if (target.megaCredits > 0) {
        ...
        availableActions.options.push(new SelectOption(optionTitle, 'Confirm', () => {
          target.addResource(Resources.MEGACREDITS, -7, player.game, player);
          return undefined;
        }));
      }
    });
