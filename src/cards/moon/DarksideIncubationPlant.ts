...
export class DarksideIncubationPlant
  extends MoonCard
  implements IActionCard, IProjectCard
{
    ...
    super(
      {
        ...
        metadata: {
          ...
          renderData: CardRenderer.builder((b) => {
            ...
            b.action(
              'Spend 2 microbes to raise the Colony Rate 1 step.',
              (eb) => {
  ...
  public action(player: Player) {
    ...
    options.push(
      new SelectOption('Add 1 microbe to this card', 'Select', () => {
