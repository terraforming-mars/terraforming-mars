    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.effect(
            'When you raise any Moon Rate, increase your M€ production 1 step per step.',
            (eb) => {
              eb.moonColonyRate({size: Size.SMALL})
                .slash()
                .moonMiningRate({size: Size.SMALL})
                .slash()
