...
export class MareSerenitatisMine
  extends MoonCard
  implements IProjectCard, IMoonCard
{
    ...
    super(
      {
        ...
        metadata: {
          description:
            'Spend 2 titanium and 1 steel. Increase your steel and titanium production 1 step ' +
  ...
  public play(player: Player) {
    ...
    const spaces = moon.getAdjacentSpaces(
      moon.getSpace(MoonSpaces.MARE_SERENITATIS)
    );
