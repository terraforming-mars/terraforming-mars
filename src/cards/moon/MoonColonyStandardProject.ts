...
export class MoonColonyStandardProject
    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) =>
          b.standardProject(
            'Spend 22 M€ and 1 titanium to place a colony on the moon and raise your M€ production 1 step.',
            (eb) => {
              eb.megacredits(22)
                .titanium(1)
                .startAction.moonColony()
