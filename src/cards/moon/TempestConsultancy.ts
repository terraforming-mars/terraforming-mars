    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.action(
            'Place 1 delegate in any party for every 5 moon tags you have [max 3.]',
            (eb) => {
              eb.empty()
                .startAction.delegates(1)
                .text('(max 3)', Size.SMALL)
                .slash()
                .text('5 ')
                .moon();
            }
          ...
          b.effect(
            'When your delegate becomes the chairman, increase your TR 1 step.',
            (eb) => {
