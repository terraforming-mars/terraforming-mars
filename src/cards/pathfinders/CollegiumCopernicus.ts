...
export class CollegiumCopernicus extends Card implements CorporationCard {
  constructor() {
    super({
...
export class TradeWithCollegiumCopernicus implements IColonyTrader {
  ...
  constructor(private player: Player) {
    const card = player.playedCards.find((card) => card.name === CardName.COLLEGIUM_COPERNICUS);
    this.collegiumCopernicus = card === undefined ? undefined : (card as CollegiumCopernicus);
  }
