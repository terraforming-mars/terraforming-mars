  ...
  constructor() {
    super({
      ...
      metadata: {
        ...
        description: 'Requires Scientists ruling your you have 2 delegates there. All players lose 2MC. Choose a tag (NOT CITY, ? OR PLANETARY TRACK) and draw 2 cards with that tag.',
      },
    });
  }
