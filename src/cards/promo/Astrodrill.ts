...
export class Astrodrill extends Card implements IActionCard, CorporationCard {
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.corpBox('action', (ce) => {
            ...
            ce.vSpace();
            ce.action(
              'Add an asteroid resource to ANY card OR gain any standard resource, OR remove an asteroid resource from this card to gain 3 titanium.',
              (eb) => {
  ...
  public action(player: Player) {
    ...
    const gainStandardResource = new SelectOption(
