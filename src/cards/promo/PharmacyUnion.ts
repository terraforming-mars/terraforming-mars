      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.corpBox('effect', (ce) => {
            ...
            ce.vSpace();
            ce.effect('When ANY microbe tag is played, add a disease here and lose 4 MC or as much as possible. When you play a science tag, remove a disease here and gain 1 TR OR if there are no diseases here, you may turn this card face down to gain 3 TR', (eb) => {
