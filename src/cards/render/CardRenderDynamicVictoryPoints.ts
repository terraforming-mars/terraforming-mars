...
export class CardRenderDynamicVictoryPoints {
  ...
  constructor(
    public item: CardRenderItem | undefined,
  ...
  public static asteroids(
    ...
    return new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.ASTEROIDS),
      points,
      target
    );
  }
  public static microbes(
    points: number,
    target: number
  ): CardRenderDynamicVictoryPoints {
    return new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.MICROBES),
      points,
      target
    );
  }
  public static animals(
    ...
    return new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.ANIMALS),
      points,
      target
    );
  }
  public static oceans(
    points: number,
    target: number
  ): CardRenderDynamicVictoryPoints {
  ...
  public static floaters(
    points: number,
    target: number
  ): CardRenderDynamicVictoryPoints {
    return new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.FLOATERS),
      points,
      target
    );
  }
  public static searchForLife(): CardRenderDynamicVictoryPoints {
    const item = new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.SCIENCE),
      3,
      3
    );
  ...
  public static fighter(
    ...
    return new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.FIGHTER),
      points,
      target
    );
  }
  public static camps(
    ...
    return new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.CAMPS),
      points,
      target
    );
  }
  ...
  public static preservation(
    points: number,
    target: number
  ): CardRenderDynamicVictoryPoints {
    return new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.PRESERVATION),
      points,
      target
    );
  }
  public static resourceCube(
    points: number,
    target: number
  ): CardRenderDynamicVictoryPoints {
    return new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.RESOURCE_CUBE),
      points,
      target
    );
  }
  public static data(
    ...
    return new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.DATA_RESOURCE),
      points,
      target
    );
  }
  public static moon(
    ...
    return new CardRenderDynamicVictoryPoints(
      new CardRenderItem(CardRenderItemType.MOON),
      points,
      target
    );
  }
  public static moonMiningTile(
    points: number,
    any: boolean = false
  ): CardRenderDynamicVictoryPoints {
