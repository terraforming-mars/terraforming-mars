...
export class UtopiaInvest extends Card implements IActionCard, CorporationCard {
    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          ...
          b.corpBox('action', (ce) => {
            ce.action(
              'Decrease any production to gain 4 resources of that kind.',
              (eb) => {
  ...
  private log(player: Player, type: string) {
    player.game.log(
      ...
      (b) => b.player(player).string(type).string(type)
    );
  }
  public action(player: Player) {
    ...
    const reduceMegacredits = new SelectOption(
    ...
    const reduceSteel = new SelectOption(
    ...
    const reduceTitanium = new SelectOption(
    ...
    const reducePlants = new SelectOption(
    ...
    const reduceEnergy = new SelectOption(
    ...
    const reduceHeat = new SelectOption(
