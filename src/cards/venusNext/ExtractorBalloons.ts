...
export class ExtractorBalloons implements IActionCard, IProjectCard, IResourceCard {
  ...
  public metadata: CardMetadata = {
    ...
    renderData: CardRenderer.builder((b) => {
      ...
      b.effectBox((be) => be.or(CardRenderItemSize.SMALL).floaters(2)
          .startAction.venus(1).description('Action: add 1 Floater to this card, or remove 2 Floaters here to raise Venus 1 step'))
          .br.floaters(3);
    }),
  }
}
