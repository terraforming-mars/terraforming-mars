<template>
  <div :class="getCardClasses(card)">
      <div class="card-content-wrapper" v-i18n>
          ...
          <CardContent v-if="getCardMetadata() !== undefined" :metadata="getCardMetadata()" :requirements="getCardRequirements()" :isCorporation="isCorporationCard()" :needSpacer="hasResourceType" />
      </div>
