                    ...
                    <div class="create-game-page-container">
                        ...
                        <div class="create-game-page-column">
                            ...
                            <label for="underworld-checkbox" class="expansion-button">
                                ...
                                <span v-i18n>Underworld 2 (alpha)</span><span></span>&nbsp;<a href="https://github.com/terraforming-mars/terraforming-mars/wiki/Underworld" class="tooltip" target="_blank">&#9432;</a>
                            </label>
                        </div>
