<template>
  <div id="create-game">
    ...
    <div class="create-game-discord-invite" v-if="playersCount === 1">
      ...
      <a href="https://discord.gg/VR8TbrD" class="tooltip" target="_blank"
    ...
    <div class="create-game-form create-game-panel create-game--block">
      <div class="create-game-options">
        <div v-if="isSoloModePage">
          <div
            class="create-game-solo-player form-group"
            v-for="newPlayer in getPlayers()"
            v-bind:key="newPlayer.index"
          >
            <div>
              <input
            ...
            <div class="create-game-colors-wrapper">
              <label
                class="form-label form-inline create-game-color-label"
                v-i18n
                >Color:</label
              >
              <span class="create-game-colors-cont">
                <label
                  class="form-radio form-inline create-game-color"
                  v-for="color in [
                    'Red',
                    'Green',
                    'Yellow',
                ...
                >
                  ...
                  <i class="form-icon"></i>
                  <div
                    :class="'board-cube board-cube--' + color.toLowerCase()"
                  ></div>
                </label>
              </span>
            </div>
          ...
          <div class="create-game-page-column">
            ...
            <label for="promo-checkbox" class="expansion-button">
              ...
              <span v-i18n>Promos</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Variants#promo-cards"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <label for="ares-checkbox" class="expansion-button">
              ...
              <span v-i18n>Ares</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Ares"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <label for="communityCards-checkbox" class="expansion-button">
              ...
              <span v-i18n>Community</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Variants#community"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <label for="themoon-checkbox" class="expansion-button">
              ...
              <span v-i18n>The Moon</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/The-Moon"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <template v-if="moonExpansion">
              ...
              <input
                ...
                id="moonStandardProjectVariant-checkbox"
              />
              <label for="moonStandardProjectVariant-checkbox">
                <span v-i18n>Standard Project Variant</span>&nbsp;<a
                  href="https://github.com/bafolts/terraforming-mars/wiki/Variants#moon-standard-project-variant"
                  class="tooltip"
                  target="_blank"
                  >&#9432;</a
                >
            ...
            <label for="pathfinders-checkbox" class="expansion-button">
              ...
              <span v-i18n>Pathfinders</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Pathfinders"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <template v-if="venusNext">
              ...
              <label for="altVenusBoard-checkbox">
                <span v-i18n>Alternate Venus Board</span> &nbsp;<a
                  href="https://github.com/bafolts/terraforming-mars/wiki/Variants#alt-venus"
                  class="tooltip"
                  target="_blank"
                  >&#9432;</a
                >
          ...
          <div class="create-game-page-column">
            ...
            <label for="WGT-checkbox">
              <span v-i18n>World Government Terraforming</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Variants#solar-phase"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <template v-if="playersCount === 1">
              ...
              <label for="soloTR-checkbox">
                <span v-i18n>63 TR solo mode</span>&nbsp;<a
                  href="https://github.com/bafolts/terraforming-mars/wiki/Variants#tr-solo-mode"
                  class="tooltip"
                  target="_blank"
                  >&#9432;</a
                >
            ...
            <label for="undo-checkbox">
              <span v-i18n>Allow undo</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Variants#allow-undo"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <label for="shuffleMap-checkbox">
              <span v-i18n>Randomize board tiles</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Variants#randomize-board-tiles"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <label for="seeded-checkbox">
              <span v-i18n>Set Predefined Game</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Variants#set-predefined-game"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <template v-if="turmoil">
              ...
              <label for="removeNegativeEvent-checkbox">
                <span v-i18n>Remove negative Global Events</span>&nbsp;<a
                  href="https://github.com/bafolts/terraforming-mars/wiki/Variants#remove-negative-global-events"
                  class="tooltip"
                  target="_blank"
                  >&#9432;</a
                >
          ...
          <div class="create-game-page-column" v-if="playersCount > 1">
              ...
              <div>
                ...
                <label for="initialDraft-checkbox">
                  <span v-i18n>Initial Draft variant</span>&nbsp;<a
                    href="https://github.com/bafolts/terraforming-mars/wiki/Variants#initial-draft"
                    class="tooltip"
                    target="_blank"
                    >&#9432;</a
                  >
            ...
            <label for="randomMA-checkbox">
              <span v-i18n>Random Milestones/Awards</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Variants#random-milestones-and-awards"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <template v-if="venusNext">
              ...
              <label for="requiresVenusTrackCompletion-checkbox">
                <span v-i18n>Mandatory Venus Terraforming</span> &nbsp;<a
                  href="https://github.com/bafolts/terraforming-mars/wiki/Variants#venus-terraforming"
                  class="tooltip"
                  target="_blank"
                  >&#9432;</a
                >
            ...
            <label for="realTimeVP-checkbox">
              <span v-i18n>Show real-time VP</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Variants#show-real-time-vp"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <label for="fastMode-checkbox">
              <span v-i18n>Fast mode</span>&nbsp;<a
                href="https://github.com/bafolts/terraforming-mars/wiki/Variants#fast-mode"
                class="tooltip"
                target="_blank"
                >&#9432;</a
              >
            ...
            <input
              type="checkbox"
              v-model="beginnerOption"
              id="beginnerOption-checkbox"
            />
                      ...
                      <div>
                        <template v-if="beginnerOption">
                          ...
                          >
                            <input
                              type="checkbox"
                              v-model="newPlayer.beginner"
                            />
                            <i class="form-icon"></i>
                            <span v-i18n>Beginner?</span>&nbsp;<a
                              href="https://github.com/bafolts/terraforming-mars/wiki/Variants#beginner-corporation"
                              class="tooltip"
                              target="_blank"
                              >&#9432;</a
                            >
                          ...
                          <label class="form-label">
                            ...
                            ><span v-i18n>TR Boost</span>&nbsp;<a
                              href="https://github.com/bafolts/terraforming-mars/wiki/Variants#tr-boost"
                              class="tooltip"
                              target="_blank"
                              >&#9432;</a
                            >
...
export default (Vue as WithRefs<Refs>).extend({
  ...
  methods: {
        ...
        function () {
          ...
          if (typeof readerResults === "string") {
            ...
            if (source !== window.location.origin) {
              alert(
                $t(
                  "Source of uploaded settings is different, there might be some inconsistencies"
                )
              );
            }
            ...
            component.showColoniesList =
              results["customColoniesList"].length > 0;
            ...
            Vue.nextTick(() => {
              if (component.showColoniesList) {
                refs.coloniesFilter.updateColoniesByNames(
                  results["customColoniesList"]
                );
              }

              if (component.showCorporationList) {
                refs.corporationsFilter.selectedCorporations =
    ...
    getPlayerNamePlaceholder(player: NewPlayerModel): string {
      return translateTextWithParams("Player ${0} name", [
        String(player.index),
      ]);
    },
    ...
    async serializeSettings() {
      ...
      if (component.randomFirstPlayer) {
        ...
        component.firstIndex =
          Math.floor(component.seed * component.playersCount) + 1;
      }
      ...
      const requiresVenusTrackCompletion =
        component.requiresVenusTrackCompletion;
      ...
      if (component.clonedGameId !== undefined && component.seededGame) {
        const gameData = await fetch(
          "/api/cloneablegame?id=" + component.clonedGameId
        ).then((response) => {
          if (response.ok) {
