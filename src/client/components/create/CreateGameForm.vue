                ...
                <div class="create-game-options">
                    <div class="create-game-page-container">
                        ...
                        <div class="create-game-page-column">
                            ...
                            <div class="warning" v-if="expansions.underworld"><span v-i18n>Underworld is slowly migrating to Underworld 2. Rules WILL change, and things that were reliable WILL break. Hence, (α).</span></div>
                        </div>
