export enum CardName {
    ...
    TRIRUM_STATION = 'Tritum Station',
    TRITON_EXPEDITION = 'Triton Expedition',
    ACUTE_RADIATION_SICKNESS = 'Acute Radiation Sickness',
    CHAIN_REACTION = 'Chain Reacion',
    DUMP_SITE = 'Dump Site',
    ENRICHMENT_FACILITY = 'Enrichment Facility',
    EVACUATION_ZONE = 'Evacuation Zone',
    EXTINCION_LEVEL_EVENT = 'Extinction-Level-Event',
    EXPLORATORY_MINING_SITE = 'Exploratory Mining Site',
    FOREST_FIRES = 'Forest Fires',
    FUEL_RODS = 'Fuel Rods',
    FUKUSHIMA_FARMING = 'Fukushima Farming',
    CEO_HEART_ATTACK = 'CEO Heart Attack',
