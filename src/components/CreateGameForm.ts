    ...
    methods: {
        ...
        createGame: function () {
            ...
            const dataToSend = JSON.stringify({
                players: players, prelude, draftVariant, showOtherPlayersVP, venusNext, colonies, customCorporationsList, board, seed, solarPhaseOption, promoCardsOption, startingCorporations 
            });
