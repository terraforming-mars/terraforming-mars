                    ...
                    <div class="create-game-page-container">
                        ...
                        <div class="create-game-page-column">
                            ...
                            <label for="themoon-checkbox" class="expansion-button">
                                ...
                                <span v-i18n>The Moon</span>&nbsp;<span style="font-size: small;">(β)</span>&nbsp;<a href="https://github.com/bafolts/terraforming-mars/wiki/The-Moon" class="tooltip" target="_blank">&#9432;</a>
                            </label>
