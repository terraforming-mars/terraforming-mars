...
export const SelectInitialCards = Vue.component('select-initial-cards', {
  ...
  <div class="select-initial-cards">
    ...
    <select-card :playerView="playerView" :playerinput="getOption(0)" :showtitle="true" v-on:cardschanged="corporationChanged" />
    <select-card v-if="hasPrelude()" :playerView="playerView" :playerinput="getOption(1)" :showtitle="true" v-on:cardschanged="preludesChanged" />
    <select-card :playerView="playerView" :playerinput="getOption(hasPrelude() ? 2 : 1)" :showtitle="true" v-on:cardschanged="cardsChanged" />
