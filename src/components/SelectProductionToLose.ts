...
export const SelectProductionToLose = Vue.component(
  'select-production-to-lose',
  {
    props: {
      player: {
      ...
      playerinput: {
        type: Object as () => Required<
          Pick<PlayerInputModel, 'title' | 'payProduction' | 'buttonLabel'>
        >,
      },
      onsave: {
