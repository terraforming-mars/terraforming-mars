...
export const Button = Vue.component("Button", {
    props: {
        ...
        size: {
            type: String,
            default: "normal",
            validator: (item) => ["small", "normal", "big", "jumbo"].includes(item),
        },
        disableOnServerBusy: {
            type: Boolean,
            default: true
        ...
        type: {
            type: String,
            default: "normal",
            validator: (item) => ["normal", "action", "max", "success", "error"].includes(item)
        },
        onClick: {
            type: Function,
            default: () => {},
    ...
    methods: {
        ...
        getDisabled: function(): boolean {
            if(this.disableOnServerBusy) {
                return this.disabled || (this.$root as any).isServerSideRequestInProgress
            }
