      ...
      <ul>
        ...
        <label for="initial-draft" class="first"><span v-i18n>Initial Drafting (optional variant)</span></label>
          <ul>
            ...
            <li v-i18n>Draw 4 prelude cards <div class="expansion-icon expansion-icon-prelude"></li>
            ...
            <li><span v-i18n>Draft the prelude cards. Pick one card and pass to the player above in turn order. Repeat until you have 4 preludes.</span>
        ...
        <li>
          ...
          <ul>
            ...
            <ul>
              <li><span v-i18n>Take 1 or 2 actions (mandatory 2 actions if playing with fast mode):</span>
                <ul>
                  ...
                  <li><span v-i18n>trade with 9 mc, 3 Ti, or 3 energy<span> <div class="expansion-icon expansion-icon-colony"></div></li>
                  <li><span v-i18n>lobby: one is free, 5 mc per delegate after<span> <div class="expansion-icon expansion-icon-turmoil"></div></li>
                </ul>
              </li>
            ...
            <ul>
              ...
              <li><span v-i18n>ii. World Government Terraforming (start player chooses)</span> <div class="expansion-icon expansion-icon-venus"></div></li>
              ...
              <li><span v-i18n>iv. Turmoil</span>
                <ul>
                  ...
                  <li><span v-i18n>4. Changing Times</span>
                    <ul>
        ...
        <li>
          ...
          <ul>
            ...
            <li><span v-i18n> Score: TR + tiles + card + milestones + awards + (1 VP per chairman and party leader</span> <div class="expansion-icon expansion-icon-turmoil"></div>)</li>
          </ul>
        </li>
