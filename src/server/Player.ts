...
export class Player implements IPlayer {
  ...
  public getSelfReplicatingRobotsTargetCards(): Array<IProjectCard> {
    return this.findSelfReplicatingRobots()?.getRobotCards() ?? [];
  }

  public findSelfReplicatingRobots(): SelfReplicatingRobots | undefined {
    return this.playedCards.find((card) => card instanceof SelfReplicatingRobots) as SelfReplicatingRobots;
  }
