...
export class MarsBotBonusResolver {
  constructor(_game: IGame, _marsBot: IPlayer, _humanPlayer: IPlayer, _turnResolver: MarsBotTurnResolver, _bonusDeck: MarsBotBonusDeck, _tilePlacer: MarsBotTilePlacer) {}
  resolve(_card: MarsBotBonusCard): void {}
  onNeuralInstancePlaced: ((space: Space) => void) | undefined;
}
