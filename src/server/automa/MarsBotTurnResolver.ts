...
export class MarsBotTurnResolver {
  ...
  constructor(game: IGame, marsBot: IPlayer, humanPlayer: IPlayer, public readonly _board: MarsBotBoard, _difficulty: DifficultyLevel, _mcSupply?: number, tilePlacer?: MarsBotTilePlacer) {
    this.board = _board;
