...
import {GetVictoryPointsContext, ICard} from '@/server/cards/ICard';
import * as DynamicVictoryPoints from '@/server/cards/render/DynamicVictoryPoints';
...
import {CardRequirementsDescriptor} from '@/server/cards/CardRequirementDescriptor';
import {CardRequirements} from '@/server/cards/requirements/CardRequirements';
