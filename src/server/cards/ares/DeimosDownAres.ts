  ...
  constructor() {
    super(
      ...
      {bonus: [SpaceBonus.ASTEROID, SpaceBonus.STEEL]},
      {
        ...
        description: 'Raise temperature 3 steps and gain 4 steel. Remove up to 6 plants from any player. Place this tile ADJACENT TO NO CITY TILE. It provides adjacency bonus of 1 asteroid and 1 steel.',
      });
  }
}
