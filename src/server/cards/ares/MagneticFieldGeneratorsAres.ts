  ...
  constructor() {
    super(
      ...
      {bonus: [SpaceBonus.PLANT, SpaceBonus.MICROBE]},
      {
        ...
        description: 'Decrease your energy production 4 steps and increase your plant production 2 steps. Raise your TR 3 steps. Place this tile, which provides an ADJACENCY BONUS of 1 plant and 1 microbe.',
      });
  }
}
