...
export const LEADER_CARD_MANIFEST = new ModuleManifest({
  ...
  leaderCards: {
    ...
    // [CardName.NAOMI]: {Factory: Naomi, compatibility: GameModule.Colonies},
    // [CardName.NEIL]: {Factory: Neil, compatibility: GameModule.Moon},
    // [CardName.OSCAR]: {Factory: Oscar, compatibility: GameModule.Turmoil},
    // [CardName.PETRA]: {Factory: Petra, compatibility: GameModule.Turmoil},
    // [CardName.QUILL]: {Factory: Quill, compatibility: GameModule.Venus},
    // [CardName.ROGERS]: {Factory: Rogers, compatibility: GameModule.Venus},
    // [CardName.RYU]: {Factory: Ryu},
    // [CardName.STEFAN]: {Factory: Stefan},
    // [CardName.TATE]: {Factory: Tate},
    [CardName.ULRICH]: {Factory: Ulrich},
    // [CardName.VAN_ALLEN]: {Factory: VanAllen},
    // [CardName.WILL]: {Factory: Will, compatibility: GameModule.Venus},
    // [CardName.XAVIER]: {Factory: Xavier, compatibility: GameModule.Prelude},
    // [CardName.YVONNE]: {Factory: Yvonne, compatibility: GameModule.Colonies},
    // [CardName.ZAN]: {Factory: Zan, compatibility: GameModule.Turmoil},
  },
});
