  ...
  constructor() {
    super({
      ...
      metadata: {
        ...
        description: 'Raise your M€ production 4 steps. Place a bronze cube on an empty unreserved space on Mars (currently Restricted Area tile.) No tile may be placed on that space for the rest of the game.',
      },
    });
  }
