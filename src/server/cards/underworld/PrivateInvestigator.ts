    ...
    super({
      ...
      metadata: {
        ...
        renderData: CardRenderer.builder((b) => {
          b.text('TARGET A PLAYER THAT HAS MORE CORRUPTION THAN YOU.', Size.SMALL).br;
          b.text('PLACE THIS CARD FACE DOWN IN THAT PLAYER\'S PROJECT CARD PILE', Size.SMALL).br;
          b.tr(1);
        }),
