...
const synergiesData: Array<[MilestoneName | AwardName, MilestoneName | AwardName, number]> = [
  ...
  ['Terra Pioneer', 'Manager', 7],
  ['Gambler', 'Manager', 0.5],
  ['Coastguard', 'Manager', 4],
  ['Entrepreneur', 'Manager', 9],
  ['Tourist', 'Manager', 2],
  ['A. Manufacturer', 'Manager', 1],
  ['Edgedancer', 'Manager', 4],
  ['Gambler', 'Martian', 0.5],
  ['Curator', 'Martian', 1],
