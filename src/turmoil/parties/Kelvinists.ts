...
export class KelvinistsPolicy01 implements Policy {
  isDefault = true;
  id = 'kp01';
  description: string = 'Spend 10 MC to increase your Energy and Heat production 1 step.';
...
export class KelvinistsPolicy03 implements Policy {
  id = 'kp03';
  description: string = 'Decrease your heat production 2 steps to gain 1 TR';
