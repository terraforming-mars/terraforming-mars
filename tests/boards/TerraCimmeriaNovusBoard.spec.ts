...
describe('TerraCimmeriaNovusBoard', () => {
  it('sanity test', () => {
    ...
    expect(board.spaces).to.deep.eq([
      ...
      {id: '06', spaceType: 'land', x: 7, y: 0, bonus: [2]},
      ...
      {id: '21', spaceType: 'land', x: 1, y: 3, bonus: [1], volcanic: true},
      {id: '22', spaceType: 'land', x: 2, y: 3, bonus: []},
      {id: '23', spaceType: 'land', x: 3, y: 3, bonus: [1]},
      {id: '24', spaceType: 'land', x: 4, y: 3, bonus: []},
      {id: '25', spaceType: 'land', x: 5, y: 3, bonus: [1, 1]},
      {id: '26', spaceType: 'land', x: 6, y: 3, bonus: []},
      {id: '27', spaceType: 'land', x: 7, y: 3, bonus: [0, 0], volcanic: true},
      {id: '28', spaceType: 'land', x: 8, y: 3, bonus: [3]},
      ...
      {id: '36', spaceType: 'land', x: 7, y: 4, bonus: [1, 3]},
      {id: '37', spaceType: 'ocean', x: 8, y: 4, bonus: []},
      {id: '38', spaceType: 'land', x: 1, y: 5, bonus: [3, 3], volcanic: true},
      {id: '39', spaceType: 'land', x: 2, y: 5, bonus: []},
      {id: '40', spaceType: 'land', x: 3, y: 5, bonus: [0, 1, 1]},
      {id: '41', spaceType: 'land', x: 4, y: 5, bonus: []},
      {id: '42', spaceType: 'land', x: 5, y: 5, bonus: [0]},
      ...
      {id: '57', spaceType: 'land', x: 7, y: 7, bonus: [2, 2]},
      {id: '58', spaceType: 'ocean', x: 8, y: 7, bonus: [2, 2]},
      {id: '59', spaceType: 'ocean', x: 4, y: 8, bonus: [2, 2]},
      {id: '60', spaceType: 'ocean', x: 5, y: 8, bonus: [2]},
      {id: '61', spaceType: 'ocean', x: 6, y: 8, bonus: [2]},
      {id: '62', spaceType: 'land', x: 7, y: 8, bonus: [2]},
      {id: '63', spaceType: 'ocean', x: 8, y: 8, bonus: [2]},
    ]);
    expect(board.volcanicSpaceIds).to.deep.eq(['05', '21', '27', '38']);
  });
});
