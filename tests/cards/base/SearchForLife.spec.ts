...
describe('SearchForLife', function() {
  ...
  it('Should act', function() {
    ...
    while (game.projectDeck.discards.find((c) => c.tags.length === 1 && c.tags[0] === Tag.MICROBE) === undefined ||
               game.projectDeck.discards.find((c) => c.tags.length === 1 && c.tags[0] !== Tag.MICROBE) === undefined) {
