...
describe("StormCraftIncorporated", function () {
    ...
    it("Validates inputs", function () {
        ...
        heatOption.cb(4);
        floaterOption.cb(0);
        expect(function () { options.cb(); }).to.throw(`Need to pay ${constants.HEAT_FOR_TEMPERATURE} heat`);
        heatOption.cb(10);
        expect(function () { options.cb(); }).to.throw(`Only need to pay ${constants.HEAT_FOR_TEMPERATURE} heat`);
    });
