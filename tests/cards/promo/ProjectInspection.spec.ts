...
describe('ProjectInspection', function() {
  ...
  it('Can be used to play Playwrights into another available event card', function() {
    ...
    const play1 = player.game.deferredActions.shift()!.execute() as SelectCard<ICard>;
    ...
    player.game.deferredActions.shift()!.execute(); // SelectHowToPay + Plays the card

    const play2 = player.game.deferredActions.shift()!.execute() as SelectCard<ICard>;
